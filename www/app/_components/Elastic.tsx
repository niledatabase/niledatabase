    ...
    <div className="flex w-full flex-col">
      ...
      <div className="flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 relative flex items-center justify-center">
          ...
          <div className="z-10 absolute top-0 -left-[10%] bottom-0 w-[21%] blur-[22px] bg-[#000]"></div>
          <div className="z-10 absolute top-0 bottom-0 -right-[10%] w-[21%] blur-[22px] bg-[#000]"></div>
          <Image
            className="relative"
            src="/elastic.png"
