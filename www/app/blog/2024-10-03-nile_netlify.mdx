export const metadata = {
  title: "End to End Serverless: Nile and Netlify Partner for Seamless Multi-Tenant Applications",
  authors: ["gwenshap"],
...
No more copy-pasting database credentials around. 
No more worrying about accidentally exposing database credentials.
Managing your database and credentials is now as easy as deploying your application to Netlify.
...
![The Nile integration in the Netlify dashboard](/blog/2024-10-03-nile_netlify/integration_dashboard.png) 
...
![Netlify environment variables](/blog/2024-10-03-nile_netlify/environment_variables.png) 
...
const client = new Client({
  connectionString: process.env.NILE_URL,
});
// or
const client = new Client({
  host: process.env.NILE_REGION.toLowerCase() + ".db.thenile.dev",
  port: 5432,
