...
Fast, responsive SaaS applications are modern. Traditionally, unlike consumer applications, SaaS has not focused much on latency. This has changed, and enterprise users expect a snappy application experience. Today, all SaaS businesses want to serve the global market from day one. With serverless and edge computing advancements, moving a tenant's data close to their location becomes critical to achieving a low latency experience. 

## **Beautiful and easy-to-use UX**
...
Applications like Figma and Notion have a collaborative experience. Many more SaaS applications are starting to support this experience. 
