...
1. In Vercel workspace, click on the **storage** tab and then on **Create Database**. Select Nile, and choose region and pricing tier. Click **Create**. <Image src="/blog/2024-11-28-nile-vercel/create_database.png" width="400" height="400" style={{ borderRadius: '12px' }} />
