export const metadata = {
  ...
  sizzle: "Discover how to supercharge your B2B apps with a serverless architecture using Nile's tenant-aware Postgres and Modal's powerful Python compute platform. Learn how we built a Sales Insights app, integrating custom LLMs like Llama 3.1, and optimized deployment for speed and scalability.",
...
![Sales Insights](/blog/2024-09-22-nile_modal/sales_insights.png)
