...
I also recieved substantial feedback that lead to an improved revision after the blog was published - thanks to [Joseph M. Hellerstein](https://twitter.com/joe_hellerstein), [Justin Gage](https://www.linkedin.com/in/gagejustin/) and [Philipp Salvisberg](https://twitter.com/phsalvisberg).
