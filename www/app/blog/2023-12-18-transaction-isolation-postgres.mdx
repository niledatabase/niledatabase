...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td>
        <code>SELECT * from accounts where acctnum = 12345;</code>
      </td>
    </tr>
    <tr>
      <td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>UPDATE accounts set balance = 500 where acctnum = 12345;</code>
      </td>
      <td></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>UPDATE accounts set balance = 500 where acctnum = 789;</code>
      </td>
      <td></td>
    </tr>
    <tr>
      <td></td>
      <td>
        <code>SELECT * from accounts where balance > 0;</code>
      </td>
    </tr>
    <tr>
      <td>
