...
const resp = await tenantNile.query("update tenants set (stripe_customer_id = $1, stripe_subscription_id = $2, tenant_tier = $3", [
...
export async function cancelSubscription(formData: FormData) {
  ...
  try {
    ...
    await tenantNile.query("update tenants set (tenant_tier = 'free' AND stripe_subscription_id = NULL)")
  } catch (e) {
    console.error(e);
