---
title: 'Nile-JS SDK DB client'
description: 'DB options for the Nile-JS SDK'
---
...
All tenants and users have access to any [shared tables](/docs/tenant-virtualization/tenant-sharing) - tables without a tenant id column.
