...
export const { handlersWithContext } = nile.api;
```
...
import { handlersWithContext } from "../../../[...nile]/nile"; // make sure you export handlersWithContext from nile.api
import { registerTenants } from "@/lib/TenantRegistration";

export async function GET(req: NextRequest) {
  const {nile, response} = await handlersWithContext.GET(req); // call the original route
