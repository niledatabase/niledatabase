...
![Tenant-Selector](/images/auth/tenantselector.png)
...
![Tenant-API](/images/auth/tenantapi.png)
...
![Tenant-SQL](/images/auth/tenantsql.png)
...
<video
  ...
  src="/images/auth/counterforblog.mp4"
></video>
...
![Table-Tenants](/images/auth/tabletenants.png)
...
![Table-Users](/images/auth/tableusers.png)

![Table-Tenant-Users](/images/auth/tabletenantusers.png)
...
![Session-Auth](/images/auth/sessionauth.png)
...
![Self-Host](/images/auth/selfhost.png)
...
![Google-Auth](/images/auth/googleauth.png)

![Discord-Auth](/images/auth/discordauth.png)
