...
However, unless the email address is **validated** in Nile Auth, the user will not be able to sign in to their email/password account after linking.
...
after linking. For this reason, we strongly recommend that you verify email addresses in your production application. 
