...
export const metadata = {
  ...
  title: "Vectors",
  description:
    "Perform operations on vector embeddings directly within niledatabase",
};
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Used in similarity comparison or feature selection. Note that for normalized vectors, 
      inner product will result in the same ranking as cosine distance, but is more efficient to calculate. 
      So this is a good choice if you use an embedding algorith that produces normalized vectors (such as OpenAI's) </td>
    </tr>
    <tr>
      <td>&lt;=&gt;</td>
      <td>
