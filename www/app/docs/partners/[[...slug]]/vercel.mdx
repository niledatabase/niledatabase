...
3. For this example, you'll also need one additional environment variable. Set `NEXT_PUBLIC_APP_URL` to the URL of your app. This is based on the proect name. 
In our case it is https://nile-vercel-nextjs.vercel.app/api
