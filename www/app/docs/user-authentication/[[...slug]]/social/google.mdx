...
We're assuming you have a Nile database up and running. If not, [sign up for Nile](https://console.thenile.dev) and follow the prompts to create a workspace and database. You'll also need a Google account and a [Google Cloud project](https://console.cloud.google.com/) for your application.
...
1. Open the [Nile Console](https://console.thenile.dev), and select the database for your application.
...
You can verify that your user was created in the [Nile Console](https://console.thenile.dev). Open the SQL editor for your database and query the users table:
