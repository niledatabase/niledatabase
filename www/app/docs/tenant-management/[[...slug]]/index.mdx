...
-- insert emploees for the second customer
insert into employees (tenant_id, id, name, age, address, start_date, title)
values 
...
--------------------------------------+------+--------+-----+----------------------+---------------------+--------------------------
 ...
 018ac98e-b37a-731b-b03a-6617e8fd5266 | 2423 | Minnie |  24 | Seattle,Washingtom   | 2018-11-11 12:09:22 | sales engineer
...
```sql
-- set the session context to a specific tenant who needs to be isolated. 
