...
<CardGroup cols={3}>
  <Card title="SQL" icon="icons/sql">
    Get started with SQL
  </Card>
  <Card title="NextJS" icon="icons/nextjs">
    Get started with NextJS
  </Card>
  <Card title="Node" icon="icons/node">
    Get started with Node
  </Card>
  <Card title="Drizzle" icon="icons/drizzle">
    Get started with Drizzle
  </Card>
  <Card title="Prisma" icon="icons/prisma">
    Get started with Prisma
  </Card>
  <Card title="Python" icon="icons/python">
