...
<CardGroup cols={3}>
  <Card title="SQL" icon="icons/sql.svg">
    Get started with SQL
  </Card>
  <Card title="NextJS" icon="icons/nextjs.svg">
    Get started with NextJS
  </Card>
  <Card title="Node" icon="icons/node.svg">
    Get started with Node
  </Card>
  <Card title="Drizzle" icon="icons/drizzle.svg">
    Get started with Drizzle
  </Card>
  <Card title="Prisma" icon="icons/prisma.svg">
    Get started with Prisma
  </Card>
  <Card title="Python" icon="icons/python.svg">
