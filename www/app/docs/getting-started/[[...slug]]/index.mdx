...
Nile reengineers PostgreSQL for multi-tenant apps, enabling to launch and scale quickly, securely, and in the most cost-effective manner. Nile can be used as a fully integrated solution or only in parts.
