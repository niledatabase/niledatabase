...
### 8.3 Tying it all together - handling a request for all todos for a tenant
...
### 8.4 Using AI models to estimate time to complete tasks
...
### 8.5 But wait, what's todoSchema and tenantSchema?
