...
export default function () {
  return (
    <Container>
      <PageHeader titleClasses="mt-44" title="Terms of Service" />
      <div className="prose prose-invert">
        <p>
          The website located at thenile.dev (the “Site”) is a copyrighted work
          belonging to Nile Platform Inc (“Company”, “us”, “our”, and “we”).
        ...
        <p>
          <span className="font-bold">
            ...
            SECTION 10.2 INCLUDES AN AGREEMENT TO ARBITRATE WHICH REQUIRES, WITH
            LIMITED EXCEPTIONS, THAT ALL DISPUTES BETWEEN YOU AND US SHALL BE
            RESOLVED BY BINDING AND FINAL ARBITRATION. SECTION 10.2 ALSO
            CONTAINS A CLASS ACTION AND JURY TRIAL WAIVER. PLEASE READ SECTION
            10.2 CAREFULLY.
          </span>
        </p>
        ...
        <div>
          ...
          <p>
            <strong>Account Creation.</strong> In order to use certain features
            of the Site, you must register for an account (“Account”) and
          ...
          <p>
            ...
            breach of security. Company cannot and will not be liable for any
        ...
        <div>
          ...
          <p>
            <strong>License.</strong> Subject to these Terms, Company grants you
          ...
          <p>
            <strong>Certain Restrictions.</strong> The rights granted to you in
          ...
          <div>
            <h2>No Support or Maintenance</h2>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              (OR OUR SUPPLIERS) BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
            ...
            <p>
              ...
              TIMES BE LIMITED TO A MAXIMUM OF FIFTY US DOLLARS. THE EXISTENCE
          ...
          <div>
            ...
            <p>
              ...
              Site, unlawfully infringing the copyright(s) in a work, and wish
              ...
              U.S.C. § 512(c)) must be provided to our designated Copyright
              Agent:
            </p>
          ...
          <div>
            ...
            <p>
              ...
              arbitrate disputes with Company, its parent companies,
              subsidiaries, affiliates, successors and assigns and all of their
              respective officers, directors, employees, agents, and
              representatives (collectively, the “Company Parties”) and limits
              the manner in which you can seek relief from the Company Parties.
            </p>
            ...
            <p>
              ...
              before you agreed to these Terms or any prior version of these
              Terms.
            </p>
            ...
            <h4>Informal Dispute Resolution</h4>
            <p>
              ...
              against the other (or initiates an action in small claims court if
              a party so elects), we will personally meet and confer
          ...
          <ul>
            <li>
              (1) your name, telephone number, mailing address, e‐mail address
              associated with your account (if you have one);
            </li>
            <li>
              (2) the name, telephone number, mailing address and e‐mail address
              of your counsel, if any; and
            </li>
            <li>(3) a description of your Dispute.</li>
          </ul>
          ...
          <p>
            ...
            1 et seq., will govern the interpretation and enforcement of this
            Arbitration Agreement and any arbitration proceedings. If the
            Informal Dispute Resolution Process described above does not resolve
            satisfactorily within 60 days after receipt of your Notice, you and
            Company agree that either party shall have the right to finally
            resolve the Dispute through binding arbitration. The Federal
          ...
          <p>
            ...
            party with a request for arbitration (the “Request”). The Request
            must include:
          </p>

          <ul>
            <li>
              (1) the name, telephone number, mailing address, e‐mail address of
              the party seeking arbitration and the account username (if
              applicable) as well as the email address associated with any
              applicable account;
            </li>
            <li>
              (2) a statement of the legal claims being asserted and the factual
              bases of those claims;
            </li>
            <li>
              (3) a description of the remedy sought and an accurate, good‐faith
            ...
            <li>
              ...
              Resolution process as described above; and
            </li>
            <li>
          ...
          <ul>
            <li>
              (1) the Request is not being presented for any improper purpose,
            ...
            <li>
              (3) the factual and damages contentions have evidentiary support
          ...
          <p>
            EXCEPT AS SPECIFIED in section 10.2(a) YOU AND THE COMPANY PARTIES
            HEREBY WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO SUE IN COURT
            AND HAVE A TRIAL IN FRONT OF A JUDGE OR A JURY...
          </p>

          <h3>Waiver of Class or Other Non-Individualized Relief</h3>
          <p>
            YOU AND COMPANY AGREE THAT, EXCEPT AS SPECIFIED IN SUBSECTION
            10.2(h) EACH OF US MAY BRING CLAIMS AGAINST THE OTHER ONLY ON AN
            INDIVIDUAL BASIS...
          </p>

          <h2>30-Day Right to Opt Out</h2>
          <p>
            You have the right to opt out of the provisions of this Arbitration
            Agreement by sending a timely written notice of your decision to opt
            out to the following address: PO Box 7775 PMB 99846, San Francisco,
            California 94120, or email to contacts@thenile.dev...
          </p>

          <h2>Invalidity, Expiration</h2>
          <p>
          ...
          <p>
            ...
            any U.S. technical data acquired from Company...
          </p>
          ...
          <p>
            Copyright © 2024 Nile Platform Inc. All rights reserved. All
            trademarks, logos and service marks (“Marks”) displayed on the Site
            are our property or the property of other third parties...
          </p>

          <div>
            <h2>Contact Information</h2>
            <p>
              <strong>Sriram Subramanian</strong>
            </p>
            <p>
              PO Box 7775 PMB 99846
              <br />
              San Francisco, California 94120
            </p>
            <p>Telephone: 480-286-9918</p>
            <p>Email: contacts@thenile.dev</p>
          </div>
        </div>
      </div>
    </Container>
