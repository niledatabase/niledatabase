# Support Okta Authentication with Next.js

export const meta = {
  title: "Support Okta Authentication with Next.js",
...
In `/app/settings/SingleSignOnSettings.tsx`, you'll find a similarly wrapped `<Okta>` component.
This is what allows your tenants to provide you with their Okta configuration.
