...
import { createCheckoutSession, cancelSubscription, redirectToStripePortal } from './checkout-actions';
...
export default async function Page({ params }: { params: { tenantid: string } }) {
    ...
    console.log("showing org dashboard for user " + tenantNile.userId + " for tenant " + tenantNile.tenantId);
    ...
    return (
      <div className={styles.center}>
            <Stack>
              <Typography level="h2" textAlign={"center"} sx={{textTransform: 'uppercase',}}>{tenant.name}&apos;s Plan and Billing</Typography>
              <MUILink href="/tenants" component={NextLink} justifyContent={"center"}>(Back to tenant selection) </MUILink>
              
              <Grid container spacing={2}   justifyContent="center" alignItems="flex-start" sx={{ flexGrow: 1, padding: "2rem" }}>
              <Grid xs={2}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography level="body-sm">
                    Free tier plan with very basic SaaS features. Enough to get a taste of the product.
                  </Typography>
                </CardContent>
              ...
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography level="body-sm">
                    The basic tier delivers good value for the money. Great for startups and small businesses.
                  </Typography>
                </CardContent>
                <CardActions buttonFlex="0 1 120px">
                ...
                <form action={redirectToStripePortal}>
                  <input type="hidden" name="tenantid" value={params.tenantid} />
                  <Button id="checkout-and-portal-button" variant="outlined" type="submit">
                  Manage
                  </Button>
                </form>
                :
                <form action={createCheckoutSession}>
                  <input type="hidden" name="lookup_key" value="price_1OZKhCJ5pwYvn8BquTcBU84h" />
                  <input type="hidden" name="tenantid" value={params.tenantid} />
              ...
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography level="title-md"> Starting at $1000/month</Typography>
                  <Typography level="body-sm">
                    This tier has advanced security and scale. Great for large companies.
                  </Typography>
                </CardContent>
                <CardActions buttonFlex="0 1 120px">
