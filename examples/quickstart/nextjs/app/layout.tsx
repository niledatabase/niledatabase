...
import NileLogo from '../public/nile_logo.svg'
...
function Card({children}: {children: JSX.Element}) {
  return (<div className="p-4 hover:shadow-lg hover:border-gray-700 border border-gray-600 rounded-lg w-60 transition-all">
        ...
        <main className="h-screen flex items-center flex-col">
          <div className="bg-black border-b-px flex flex-row justify-between w-full items-center px-6 py-4">
            ...
            <div>
              ...
              >
                <div className="text-white flex flex-row gap-3 items-center">Created by{" "}
