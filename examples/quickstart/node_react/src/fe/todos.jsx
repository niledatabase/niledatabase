...
export default function Todos() {
    ...
    return (
      <div id="todo">
        <Stack  direction="column" flexWrap="wrap" useFlexGap sx={{paddingLeft: "5rem", paddingTop: "5rem"}}>
            ...
            {!data ? 
                ...
                : 
                <Table aria-label="basic table" variant="outline" size="lg" sx={{padding: '2rem', width: "80%"}}>   
                    <thead> 
                        <tr>
                            <th>Title</th>
                            <th>Completed</th>
