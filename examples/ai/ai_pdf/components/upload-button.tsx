        ...
        >
          <div className="flex h-full w-full items-center justify-center">
            <label
              ...
              className="bg-card-muted flex h-full w-full cursor-pointer flex-col items-center justify-center rounded-lg hover:bg-card-foreground"
            >
              ...
              {acceptedFiles && acceptedFiles[0] && isUploading ? (
                <div className="flex max-w-xs items-center divide-x divide-zinc-200 overflow-hidden rounded-md bg-muted outline outline-[1px] outline-zinc-200">
              ...
              {isUploading ? (
                <div className="mx-auto mt-4 w-full max-w-xs">
                  ...
                  />
                  {uploadProgress === 100 ? (
                    <div className="flex items-center justify-center gap-1 pt-2 text-center text-sm text-green-300">
