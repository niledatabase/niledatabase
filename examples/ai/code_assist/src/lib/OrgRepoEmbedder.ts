...
await embedDirectory('~/workspaces/ai-chatbot', 'typescript','vercel', 'Next.js AI chatbot','https://github.com/vercel/ai-chatbot')
await embedDirectory('~/workspaces/ai/examples/next-huggingface', 'typescript','vercel', 'NextJS + HuggingFace example','https://github.com/vercel/ai')
await embedDirectory('~/workspaces/ai/examples/next-openai', 'typescript','vercel', 'NextJS + OpenAI example','https://github.com/vercel/ai')

// Embed PGVector projects
await embedDirectory('~/workspaces/pgvector-go', 'go','pgvector', 'pgvector support for Go','https://github.com/pgvector/pgvector-go')
await embedDirectory('~/workspaces/pgvector-rust', 'rust','pgvector', 'pgvector support for Rust','https://github.com/pgvector/pgvector-rust')
await embedDirectory('~/workspaces/pgvector-node', 'javascript','pgvector', 'pgvector support for Node','https://github.com/pgvector/pgvector-node')
await embedDirectory('~/workspaces/pgvector-python', 'python','pgvector', 'pgvector support for Python','https://github.com/pgvector/pgvector-python')

// Embed Replit Kaboom
await embedDirectory('~/workspaces/kaboom', 'typescript','Replit', 'Javascript Game Library','https://github.com/replit/kaboom')

// Embed Langchain projects
await embedDirectory('~/workspaces/chat-langchain', 'python','langchain-ai', 'Chat Langchain (Python)','https://github.com/langchain-ai/chat-langchain')
await embedDirectory('~/workspaces/chat-langchain', 'typescript','langchain-ai', 'Chat LangChain (Python)','https://github.com/langchain-ai/chat-langchain')
await embedDirectory('~/workspaces/chat-langchainjs', 'typescript','langchain-ai', 'Chat LangChain.js','https://github.com/langchain-ai/chat-langchainjs')
await embedDirectory('~/workspaces/weblangchain', 'typescript','langchain-ai', 'Web Search Chatbot','https://github.com/langchain-ai/weblangchain')

// Embed LlamaIndex projects
await embedDirectory('~/workspaces/chat-llamaindex', 'typescript','run-llama', 'LlamaIndex Chat','https://github.com/run-llama/chat-llamaindex')
await embedDirectory('~/workspaces/sec-insights', 'python','run-llama', 'SEC Insights','https://github.com/run-llama/sec-insights')
await embedDirectory('~/workspaces/sec-insights', 'typescript','run-llama', 'SEC Insights','https://github.com/run-llama/sec-insights')