    ...
    <div className="min-h-screen bg-gradient-to-r from-red-100 to-green-100 flex flex-col items-center justify-center p-4">
      <Card className="w-full max-w-4xl bg-white/80 backdrop-blur-sm">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-bold text-red-600">Holiday Wishes App</CardTitle>
          <CardDescription className="text-xl text-green-700">Spread joy this holiday season!</CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <p className="text-sm text-gray-600">Manage multiple organizations with ease</p>
            </div>
            <div className="flex flex-col items-center space-y-2">
