  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <Image src="/lambda_logo.svg" alt="Lambda Logo" className={styles.logo} width={40} height={40} style={{marginRight:"1rem"}} /> AWS Lambda
        </div>
      ...
      <div>
        ...
        <Card variant="outlined"
          ...
          <Link overlay href="https://www.thenile.dev/docs/serverless/lambda" target="_blank" rel="noopener" 
            style={{fontSize:"18px", alignItems:"center", display:"flex", color:"black"}}>
          <Image src="/lambda_logo.svg" alt="Lambda Logo" className={styles.logo} width={30} height={30} style={{marginRight:"1rem"}} /> AWS Lambda
            </Link>
          <CardContent>
